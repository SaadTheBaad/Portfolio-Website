...
const projects = [
  {
    ...
    results: [
      {
        title:
          "Built a high-performance Pokémon data app focused on speed, caching, and UX",
      },
      {
        title:
      ...
      {
        title:
          "Designed secure, persistent user profiles with Firebase Auth and Supabase",
      },
    ],
    link: "",
  ...
  },
  {
    ...
    results: [
      {
        title:
          "Social accountability app that turns personal goals into shared, time-bound challenges",
      },
      {
        title:
